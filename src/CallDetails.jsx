...
import { formatPhoneNumber } from './Helpers.jsx';
        ...
        >
            ...
            >
                <div className="flex justify-between">
                    ...
                    <span className="text-gray-800">{formatPhoneNumber(callData?.from)}</span>
                </div>
                <div className="flex justify-between">
                    <span className="font-medium text-gray-600">To:</span>
                    <span className="text-gray-800">{formatPhoneNumber(callData?.to)}</span>
                </div>
                <div className="flex justify-between">
                    <span className="font-medium text-gray-600">Via:</span>
                    <span className="text-gray-800">{formatPhoneNumber(callData?.via)}</span>
                </div>
                <div className="flex justify-between">
